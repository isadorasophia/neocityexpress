...
namespace FMOD
{
    ...
    */
    ...
    public struct DSP_PARAMETER_FFT
    {
        ...
        private readonly IntPtr[] _spectrumInternal;
        ...
        public float[][] Spectrum
        {
            get
            {
                ...
                for (int i = 0; i < Numchannels; ++i)
                {
                    ...
                    Marshal.Copy(_spectrumInternal[i], buffer[i], 0, Length);
                }
        ...
        public void GetSpectrum(int channel, ref float[] buffer)
        {
            ...
            Marshal.Copy(_spectrumInternal[channel], buffer, 0, bufferLength);
        }
    }
